function writeMariaMeas(outputDir,suffix)
...
%compared with Xiaojing, I renamed the metabolites for GLC6P, DHAP, G3P,
%ThreePG, P5P, E4P, S7P, GLY, TRP, CIT, AKG, SUC, and ASP, and removed LAC,
%VALX, OAA and CITR entirely. Note I am uncertain about whether the new
%matches for G3P, ThreePG, S7P, and AKG are completely correct.
modelMetsToXiaojingMets=containers.Map({'GLC6P#111111','F6P#111111','F16BP#111111','DHAP#111','G3P#111','ThreePG#111', ...
    'PYR#111','P5P#11111','E4P#1111','S7P#1111111','SER#111','GLY#11','PHEX#111111111', ...
    'TYRX#111111111','TRPX#11111111111','CIT#111111','AKG#11111','SUC#1111','GLN#11111','GLU#11111', ...
    'ALA#111','ASP#1111','ORN#11111','PRO#11111','ARG#111111','ASN#1111'}, ...
    {'G6P or F6P','G6P or F6P','fructose-16-bisphosphate', ...
    'Dihydroxyacetone phosphate','Dihydroxyacetone phosphate','Phosphoenolpyruvate','pyruvate','D-ribose-5-phosphate', ...
    'D-Erythrose 4-phosphate','sedoheptulose 17-bisphosphate(4-)','serine','glycine','phenylalanine','tyrosine','L-tryptophan', ...
    'citrate/isocitrate/Diketogulonic acid','2-oxoglutarate(2-)','succinate(2-)','glutamine','L-glutamate(1-)','alanine','L-aspartate(1-)', ...
    'ornithine','proline','arginine','asparagine'});
